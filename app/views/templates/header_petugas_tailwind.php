            ...
            <div class="max-w-[1400px] mx-auto flex items-center justify-between gap-8">
                <div class="flex items-center gap-8">
                    ...
                    <nav class="hidden md:flex items-center gap-6">
                        <?php
                        $navItems = [
                            'Dashboard Petugas' => BASE_URL . '/petugas',
                            'Kelola Peminjaman' => BASE_URL . '/petugas/peminjaman', // Validasi
                            'Proses Pengembalian' => BASE_URL . '/petugas/pengembalian'
                        ];
                        ...
                        foreach ($navItems as $title => $url) {
                            ...
                            $displayTitle = $title;
                            if ($title == 'Dashboard Petugas')
                                $displayTitle = 'Dashboard';
                            if ($title == 'Kelola Peminjaman')
                                $displayTitle = 'Validasi';
                            if ($title == 'Proses Pengembalian')
                                $displayTitle = 'Pengembalian';
                ...
                <div class="flex flex-1 justify-end items-center gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="text-right hidden lg:block">
                            ...
                            <p class="text-xs text-slate-500 mt-1">Petugas Lab</p>
                        </div>
                        <div
